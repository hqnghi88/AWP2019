...
//		save [the_alert_strategy,time_before_hazard,casualties]  type: "csv" to: "results.csv" rewrite: false;
		do pause;
	}
...
experiment exp_batch type: batch repeat: 2 until: inhabitant all_match (each.saved or each.drowned) {
	parameter "Alert Strategy" var:the_alert_strategy init:"DEFAULT" among:["STAGE","SPATIAL","DEFAULT"] category: "Strategy";
	parameter "Time before hazard" var:time_before_hazard init:0#h min:0#mn max:2#h step: 30#mn category: "Hazard";
